/**
 * CLI tool definitions — pure declarative data.
 *
 * Extracted from tool-registry.ts per Team Standards §5.3.
 * Each entry maps to an `echoclaw` CLI command spawned by executor.ts.
 *
 * NAMING CONVENTION:
