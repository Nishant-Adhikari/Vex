...
vi.mock("@vex-agent/db/repos/messages.js", async () => {
  const actual = await vi.importActual<typeof import("../../../../vex-agent/db/repos/messages.js")>(
...
vi.mock("@vex-agent/db/repos/session-episodes.js", async () => {
  const actual = await vi.importActual<typeof import("../../../../vex-agent/db/repos/session-episodes.js")>(
    "@vex-agent/db/repos/session-episodes.js",
  );
  return {
    ...actual,
...
} = await import("../../../../vex-agent/engine/core/checkpoint.js");
