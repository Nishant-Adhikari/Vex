...
const { hydrateEngineSession } = await import("../../../../echo-agent/engine/core/hydrate.js");
...
describe("hydrate", () => {
  ...
  it("hydrates a basic chat session", async () => {
    mockGetSession.mockResolvedValueOnce({
      id: "session-1", scope: "echo", summary: null,
  ...
  it("hydrates a mission session with active run", async () => {
    mockGetSession.mockResolvedValueOnce({
      id: "session-1", scope: "echo", summary: "Previous summary",
  ...
  it("detects subagent sessions via session_links", async () => {
    mockGetSession.mockResolvedValueOnce({
      id: "session-child", scope: "echo", summary: null,
