...
vi.mock("../../../../echo-agent/engine/core/turn.js", () => ({
  executeTurn: vi.fn(),
  saveAssistantMessage: vi.fn(),
}));

const turnLoopModule = await import("../../../../echo-agent/engine/core/turn-loop.js");
const turnModule = await import("../../../../echo-agent/engine/core/turn.js");
