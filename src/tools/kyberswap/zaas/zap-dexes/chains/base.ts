...
export const BASE_ZAP_DEXES: ChainZapDexConfig = {
  ...
  dexes: [
    ...
    { id: "DEX_SUSHISWAPV3", name: "SushiSwap V3", supports: [...ALL_OPS], verification: "verified", dexscreenerIds: ["sushiswap"] },
    { id: "DEX_SUSHISWAPV2", name: "SushiSwap V2", supports: [...ALL_OPS], verification: "verified", dexscreenerIds: ["sushiswap"] },
    { id: "DEX_AERODROMECL", name: "Aerodrome CL", supports: [...ALL_OPS], verification: "verified", dexscreenerIds: ["aerodrome"] },
    { id: "DEX_AERODROMEBASIC", name: "Aerodrome Basic", supports: [...ALL_OPS], verification: "verified", dexscreenerIds: ["aerodrome"] },
    { id: "DEX_SWAPMODEV3", name: "SwapMode V3", supports: [...ALL_OPS], verification: "verified" },
    { id: "DEX_SWAPMODEV2", name: "SwapMode V2", supports: [...ALL_OPS], verification: "verified" },
    ...
    { id: "DEX_QUICKSWAPV4", name: "QuickSwap V4", supports: [...ALL_OPS], verification: "verified" },
