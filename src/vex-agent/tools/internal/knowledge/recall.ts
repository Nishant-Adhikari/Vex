...
import * as recallCacheRepo from "@vex-agent/db/repos/recall-cache.js";
import { embedQuery } from "@vex-agent/embeddings/client.js";
import { loadEmbeddingConfig } from "@vex-agent/embeddings/config.js";
import { clampRecallK } from "@vex-agent/knowledge/policy.js";
import { rerank, type RecallCandidate } from "@vex-agent/knowledge/ranking.js";
import { splitInlineAndOverflow } from "@vex-agent/knowledge/recall-payload.js";
...
function toInlineDto(entry: import("@vex-agent/knowledge/ranking.js").RankedRecallResult): InlineDto {
  return {
    id: entry.id,
    kind: entry.kind,
    title: entry.title,
