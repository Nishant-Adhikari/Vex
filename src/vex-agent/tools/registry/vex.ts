 ...
 *
 * Two curated entry-points the host model uses to orient itself in the
 * Vex tool surface. Registered FIRST in `registry.ts:TOOLS` so they sit
 * at the top of the LLM-visible list — strong prior toward calling them
 * before issuing a discover_tools.
 *
