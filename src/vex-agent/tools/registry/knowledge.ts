...
export const KNOWLEDGE_TOOLS: readonly ToolDef[] = [
  {
    ...
    description:
      ...
      + "Do not save: balances, prices, gas, open positions, quotes, tx hashes — those are live state, queried via wallet_balances / khalani_* / portfolio each turn. Anything already in proj_* / mission_runs / approval_queue is structured DB state, not knowledge. Raw secrets / mnemonics / private keys NEVER. "
      + ""
