...
export const MISSION_TOOLS: readonly ToolDef[] = [
  {
    ...
    parameters: { type: "object", properties: {
      ...
      stopConditions: { type: "array", items: { type: "string" }, description: "User-approved conditions that stop the mission without success" },
      stopConditionsAccepted: { type: "boolean", description: "Set true only when the user directly provided or explicitly accepted the stopConditions list" },
