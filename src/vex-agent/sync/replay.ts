 ...
 *   - `src/vex-agent/e2e/core/replay-check.ts` — e2e smoke that verifies
...
import { MUTATION_MATRIX, isExpectedType } from "@vex-agent/tools/protocols/mutation-matrix.js";
import { extractExternalRefs, replayActivityFromCapture } from "@vex-agent/tools/protocols/capture-pipeline.js";
