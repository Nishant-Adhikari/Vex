...
/**
 * Attribute FINAL open positions to what THIS mission added, not the whole
 * wallet bag. Pre-existing dust (captured at start) must not pollute the run's
 * result row, and adding to an existing position should record only the delta.
 */
