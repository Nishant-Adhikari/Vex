...
/**
 * TTL for tool output blobs. Matches `RECALL_CACHE_TTL_MIN` so resume paths
 * can refresh TTLs in one unified window; shorter would risk losing the
