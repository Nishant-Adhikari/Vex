...
- `tool-usage.ts` — discover/execute contract, 2-step transfer rule, token verification rule (resolve before mutate), DeFi safety rules (gas reserve, fresh balance, quote-before-execute, address-first), portfolio_inspect self-inspection guide
