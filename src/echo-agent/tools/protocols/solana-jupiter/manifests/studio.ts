...
export const STUDIO_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "website", type: "string", description: "Project website URL." },
      { key: "twitter", type: "string", description: "Twitter/X handle or URL." },
      { key: "telegram", type: "string", description: "Telegram group URL." },
      { key: "feeBps", type: "number", description: "Trading fee in basis points (default: 100 = 1%)." },
      { key: "isLpLocked", type: "boolean", description: "Lock LP tokens (default: true)." },
    ],
