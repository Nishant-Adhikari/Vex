...
export const SWAP_TOOLS: readonly ProtocolToolManifest[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "deadlineSec", type: "number", description: "Transaction deadline in seconds (default: 90)." },
      { key: "approveExact", type: "boolean", description: "Approve exact amount instead of unlimited." },
  ...
  {
    toolId: "jaine.swap.buy",
    namespace: "jaine",
    lifecycle: "active",
    description: "Buy exact amount of output token on Jaine DEX (0G Network). Uses exactOutput routing — specify how much you want to receive.",
    mutating: true,
    params: [
      { key: "tokenIn", type: "string", required: true, description: "Input token — symbol (e.g. USDC, w0G) or address." },
      { key: "tokenOut", type: "string", required: true, description: "Output token — symbol or address." },
      { key: "amountOut", type: "string", required: true, description: "Desired output amount in human-readable units." },
      { key: "slippageBps", type: "number", description: "Slippage tolerance in basis points (default: 50 = 0.5%)." },
      { key: "maxHops", type: "number", description: "Max routing hops (default: 3)." },
      { key: "recipient", type: "string", description: "Recipient address (default: sender wallet)." },
      { key: "deadlineSec", type: "number", description: "Transaction deadline in seconds (default: 90)." },
    ...
    exampleParams: { tokenIn: "USDC", tokenOut: "w0G", amountOut: "10", slippageBps: 50 },
  },
];
