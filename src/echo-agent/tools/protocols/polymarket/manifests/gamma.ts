...
export const GAMMA_TOOLS: readonly ProtocolToolManifest[] = [
...

  {
    ...
    lifecycle: "active",
    description: "Browse prediction market events — filter by tag, active/closed/featured status, min liquidity/volume. Includes nested markets.",
    mutating: false,
    params: [
    ...
    exampleParams: { active: true, featured: true, limit: 20 },
  },
  {
...

  {
    ...
    namespace: "polymarket",
    lifecycle: "active",
    description: "Browse prediction markets with filters — includes prices, liquidity, volume, clobTokenIds.",
    mutating: false,
    params: [
      { key: "limit", type: "number", description: "Max results." },
      { key: "offset", type: "number", description: "Pagination offset." },
