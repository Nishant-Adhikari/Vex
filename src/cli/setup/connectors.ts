  ...
  return [
    ...
    },
    {
      ...
      nextSteps: [
        ...
        "Use `claude mcp list` to verify Vex was registered.",
      ],
      quickstartPrompt,
      artifacts: [
        {
        ...
        },
        {
          ...
          description: "Exact Claude Code command to register Vex locally.",
        },
        quickstartArtifact,
      ],
    },
    {
      ...
      nextSteps: [
        ...
        "Use `codex mcp list` to confirm that Vex is configured.",
      ],
      quickstartPrompt,
      artifacts: [
        {
          ...
          description: "Exact Codex CLI command to register Vex.",
        },
        quickstartArtifact,
      ],
    },
    {
      ...
      artifacts: [
        ...
        },
        {
          ...
          description: "Exact OpenClaw command to register Vex.",
        },
        quickstartArtifact,
      ],
    },
...
export function writeConnectorArtifacts(baseDir: string = CONNECTORS_DIR): GeneratedConnectorOutput {
  ...
  try {
    ...
    throw new VexError(
      ...
      "Check permissions for the Vex config directory.",
    );
  }
}
