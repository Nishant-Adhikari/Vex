...
export const ENV_FIELDS: readonly EnvFieldSpec[] = [
  {
    key: "ECHO_AGENT_DB_URL",
    required: true,
    description: "Local Postgres database used by EchoClaw MCP.",
  },
  {
...
export function getEvmWalletStatus(): WalletStatus {
  ...
  if (!password) {
    return {
      ...
      status: "missing",
      address,
      detail: "ECHO_KEYSTORE_PASSWORD is missing in CONFIG_DIR/.env.",
      hasStoredState,
    };
  }
