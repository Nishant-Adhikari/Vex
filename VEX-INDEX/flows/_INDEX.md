...
- `FLOW-chat-turn` — `flows/FLOW-chat-turn.md`. User chat submit → engine turn loop → stream → transcript. Covers F1 provider gate, F4 fix (loadConfig cache), F5 polling fallback.
