 ...
 * `--dockerbootstrap-accent` so they read as a single design system.
 */
...
export function ContinueButton({ onClick }: ContinueButtonProps): JSX.Element {
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "inline-flex items-center gap-2 rounded-xl border border-white/[0.16] bg-[var(--dockerbootstrap-accent)]/85 px-5 py-2.5 font-mono text-xs uppercase tracking-[0.22em] text-white backdrop-blur-md",
        "shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_8px_28px_rgba(50,117,248,0.28)]",
        "hover:bg-[var(--dockerbootstrap-accent)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.26),0_12px_40px_rgba(50,117,248,0.42)]",
