/**
 * Models TanStack Query hook (agent integration puzzle 1).
 *
 * Read-only — returns `source: "global_default"` (single env-derived
 * option) or `source: "unconfigured"` (empty list). No network call.
 * OpenRouter catalogue + per-session model picker land in puzzle 06.
 */
