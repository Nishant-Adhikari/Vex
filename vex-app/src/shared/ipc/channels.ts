...
export const CH = {
  ...
  mission: {
    ...
    listPaperResults: "vex:mission:listPaperResults",
    getResultForRun: "vex:mission:getResultForRun",
    getRetrospective: "vex:mission:getRetrospective",
    simulatorLaunchPreset: "vex:mission:simulatorLaunchPreset",
    simulatorStartBatch: "vex:mission:simulatorStartBatch",
    simulatorGetLatestBatch: "vex:mission:simulatorGetLatestBatch",
    simulatorListBatches: "vex:mission:simulatorListBatches",
  },
